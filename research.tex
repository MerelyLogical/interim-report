...
arithmetic operations with MSD first~\cite{Ercegovac1}~\cite{Ercegovac2}.
Pipelining can be used with on-line serial arithmetic operators.
...
The way on-line arithmetic alleviates the problem of fixed precision
