...
This was chosen as the additional complexity of a high-radix operator does not
always provide justifiable speedups except in specific
cases~\cite{Kornerup1}\cite{Amin1}.
